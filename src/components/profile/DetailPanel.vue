<template>
    <section class="m-2" :class="[shadow, infoSize, padding]">
        ...
        <div>
            <p>{{ profileInfo.addressLine1 }}</p>
            <p>{{ profileInfo.addressLine2 }}</p>
            <p>{{ profileInfo.addressLine3 }}</p>
            <p>{{ profileInfo.postCode }}</p>
        </div>
    </section>
</template>
